...
excerpt: "<i>Co-building an iOS application with QR-based item scanner, RFID-based object movement control and external database connection</i><br/><img src='/images/neverrunout-5.png' alt='Never Run Out iOS app screen showing fridge item scanning'>"
...
<br/><img src='/images/neverrunout-4.png' alt='Never Run Out system demonstrated at a public kitchen appliances showcase'>

<br/>🛒 With the application, users can <b>scan their food</b> as they go into the fridge or the freezer. For the first version, we used QR codes to make things a bit easier. The scanning may also be done with the barcode in later iterations. 
