...
Every investor has a different set of theses as well as other possible quantitative models accompanying these theses. Our intention is not to detail any specific way 212 handles these; instead, we want to start a general discussion on all the concepts that matter. Irrespective of the fund size, theses, or any other subjective constraint, we want to share perspectives on universally essential concepts.
